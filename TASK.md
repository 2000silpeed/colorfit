...
- [ ] 12개 톤별 JSON 파일 생성 (예: `spring_warm_light.json`)
- [ ] 각 톤당 20~30개 대표 색상 (HEX, RGB, HSL, 한글 색상명)
- [ ] 총 ~300개 색상 데이터
- [ ] 참조: 기획서 섹션 7.1 (12-tone 분류 체계)

**Task 1.2 — 브랜드 화이트리스트 JSON**
- [ ] `backend/data/brand_whitelist.json` 생성
- [ ] 인지도 있는 브랜드 120개+ 리스트 (무신사 스탠다드, 유니클로, COS 등)
- [ ] 형식: `["무신사 스탠다드", "유니클로", ...]`

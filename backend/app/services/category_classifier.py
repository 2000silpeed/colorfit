...
CATEGORY_KEYWORDS: dict[str, dict[str, list[str]]] = {
    ...
    "bag": {
        "가방": ["가방", "백팩", "토트백", "크로스백", "숄더백", "클러치", "메신저백", "에코백", "허리백", "웨이스트백", "벨트백", "힙색", "파니팩", "범백", "슬링백"],
    },
    "acc": {
...
RAW_CATEGORY_MAP: dict[str, str] = {
    ...
    "실내화": "샌들",
    # 가방
    "숄더백": "가방", "크로스백": "가방", "토트백": "가방",
    "에코백": "가방", "파우치": "가방", "백팩": "가방",
    "클러치": "가방",
    # 악세서리
    "스카프": "액세서리", "귀걸이": "액세서리", "여성장갑": "액세서리",
    "모자": "액세서리",
}
